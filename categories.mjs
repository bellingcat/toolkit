...
const whitelist = ['twitter', 'instagram', 'facebook', 'youtube', 'telegram', 'tiktok', 'discord', 'multiple-networks', 'linkedin', 'reddit', 'vkontakte', 'other-networks', 'reverse-image-search'];

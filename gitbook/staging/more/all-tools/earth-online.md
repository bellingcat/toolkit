...
<figure><img src="../../.gitbook/assets/unknown (2).png" alt=""><figcaption><p>The EO visuals connect the satellite info to related data applications (thematic visuals), mission information, satellite data and tools. t<a href="https://visuals.earth.esa.int/">https://visuals.earth.esa.int/</a></p></figcaption></figure>
...
The [CDSE](earth-online.md#url) provides a wide range of data and services from the Copernicus Sentinel missions and some complementary data. The Copernicus browser (see [Bellingcat tool guide](https://bellingcat.gitbook.io/toolkit/more/all-tools/sentinal-hub-playground)) is a part of the wider ecosystem. The cloud-based data and processing platform provides data and documentation, with advanced features that include cloud computing, integrated jupyter notebooks, APIs, batch operations, and building workflows with [openEO](https://dataspace.copernicus.eu/ecosystem/services/openeo), the API service.

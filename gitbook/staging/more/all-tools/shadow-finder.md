...
[Accuracy of your input measurements](shadow-finder.md#data-input-options) affects the size of the matching output area. A small output area is usually desirable for a researcher, since it reduces the search space of a geolocation.

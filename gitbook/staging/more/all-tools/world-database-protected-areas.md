...
The easiest way would be to use Google Earth Pro. (For those unfamiliar with Google Earth Pro, see the Bellingcat Toolkit entry [here](world-database-protected-areas.md#url).)\
\
...
* Rarity-weighted richness map (IUCN [dataset ](world-database-protected-areas.md#url)[download page](https://www.iucnredlist.org/resources/other-spatial-downloads))

...
Tencent Maps has API documentation available for [switching between 2D/3D models](https://lbs.qq.com/webDemoCenter/glAPI/glMap/map3d) and for [showing 3D buildings](tencent-maps.md#url).
...
1. Select **Layers > Street View** (see [**Annotated Menu - mobile app**](tencent-maps.md#annotated-menu-mobile)). The blue lines along the roads indicate that street view is available.

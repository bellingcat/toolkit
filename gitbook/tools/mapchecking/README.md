...
Have a look at this [reference guide ](https://www.gkstill.com/Support/crowd-density/CrowdDensity-1.html)and scroll down to "4 people per square metre" crowd density for and "4.5 people per square meter". Compare this to a clear photo of the reference image if possible from the event in question. Looking at both images can assist users in making estimations on crowd density.&#x20;

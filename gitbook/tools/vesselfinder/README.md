...
* Embedding a map on a website - VesselFinder allows map embedding maps on websites by inserting HTML codes. Here is a [list of the codes](https://www.vesselfinder.com/embed) that can be used.

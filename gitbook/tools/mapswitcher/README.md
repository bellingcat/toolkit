...
{% hint style="info" %}
It is no longer possible to download the released version of the app from the Chrome Store, where the page for this tool has a post saying it is unavailable.
{% endhint %}

<figure><img src=".gitbook/assets/mapSwitcherScreenshot16thFeb (1).png" alt=""><figcaption><p><strong>THE MAPSWITCHER EXTENSION MENU OVER A GOOGLE CHROME BROWSER PAGE</strong></p></figcaption></figure>
...
The most difficult part of using MapSwitcher is its installation as a Chrome Browser Extension, if a user is unfamiliar with browser extension installation.
...
If a user tries to use MapSwitcher on an app for which is not on its input/output list, they will see the following message:

<figure><img src=".gitbook/assets/image (1) (4).png" alt=""><figcaption><p>MAP SWITCHER MESSAGE WHEN SWITCHING IS NOT POSSIBLE</p></figcaption></figure>

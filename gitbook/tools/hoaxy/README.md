...
<div align="center"><figure><img src=".gitbook/assets/Temporal trends 1 (1).png" alt="" width="188"><figcaption><p>(Click to enlarge) This image shows the timeline of how posts about a specific topic spread over time. In this example, the tool automatically generates a timeframe from 13 March 2024 to 17 April 2024 (shown in the orange square). On the top of the image are options to "add old posts" or "add new posts" (shown in green circles).</p></figcaption></figure></div>
...
<figure><img src=".gitbook/assets/Middle Panel (1) (1).png" alt=""><figcaption><p>The screenshot shows the middle menu for the visualization and the different ways users can display their results for analysis.</p></figcaption></figure>

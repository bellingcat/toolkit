...
**Environmental monitoring purposes**: [Global Forest Watch](https://www.globalforestwatch.org/) currently offers low resolution Sentinel-2 (10m res) & Landsat 8 (30m res) imagery for near real-time checks. See the [Bellingcat Toolkit guide to Global Forest Watch](https://bellingcat.gitbook.io/toolkit/more/all-tools/global-forest-watch) here.&#x20;

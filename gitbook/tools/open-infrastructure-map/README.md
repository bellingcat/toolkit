...
Once the user has zoomed in sufficiently on a location — e.g. a power station -- the user can left click on it, which opens a mini window containing additional details about the location. <mark style="color:$warning;">\<show an example of a mini-window, with an explanation of what it shows></mark>

The map also provides a selectable "[nighttime lights](https://mapyourgrid.org/tools/)" background option, in addition to the standard OSM background.  <mark style="color:$warning;">(Explain how this provides new insights into infrastructure, or delete this.)</mark>
...
<mark style="color:$warning;">See if can find potential cases for open source researchers and journalists.</mark>

## Cost <mark style="color:$warning;">(add what's free and what's paid)</mark>

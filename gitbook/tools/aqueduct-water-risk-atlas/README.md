...
<figure><img src="../../.gitbook/assets/Screenshot 2026-02-22 at 10.34.40 (1).png" alt=""><figcaption><p>View of the Water Risk Atlas by drinking water levels (feb 2026)</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2026-03-08 at 16.24.38 (1).png" alt=""><figcaption><p>Definitions of indicators such as Water Stress are available by clicking on the question mark icon. The weighting of the indicators can be adjusted, in fixed steps.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2026-02-22 at 11.02.11 (1).png" alt=""><figcaption><p>The risk and cost-benefit analysis of the flood tool lets you select two locations (on country, state or water basin level) to compare; in this case, Japan and Netherlands were selected.</p></figcaption></figure>
...
The raw data is further processed and standardised by the [World Resources Institute](https://www.wri.org/) into global water risk indicators. See the info on [Water Risk Indicators](https://www.wri.org/aqueduct/help-center/water-risk-indicators) and the [Aqueduct 4.0 release notes](https://www.wri.org/research/aqueduct-40-updated-decision-relevant-global-water-risk-indicators) for detailed information per indicator on the data providers and the used methodology.
...
* The Aqueduct tools are web-based and require not more than an internet connection. Some familiarity with GIS and water risk indicators is a plus.
...
The US-based [World Resources Institute](https://www.wri.org/) (WRI), a global research organisation committed to sustainability and environmental resource management.
...
Aqueduct can be complemented with [https://bellingcat.gitbook.io/toolkit/more/all-tools/resource-watch](https://bellingcat.gitbook.io/toolkit/more/all-tools/resource-watch "mention") for context and data from other environmental domains.
{% endhint %}

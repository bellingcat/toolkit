...
updated: '2026-06-30'
description: >-
  Tilting global map of 3D buildings and the shadows they cast at a specific
  time of the day, but date fixed at "today" in free version. Paid versions
  allow date change, satellite view & 3D models.
---
...
<figure><img src=".gitbook/assets/VersionsTablefREE1 (1).jpg" alt=""><figcaption><p>COMPARING THE FOUR VERSIONS OF SHADOWMAP: FREE, EXPLORER, HOME &#x26; STUDIO</p></figcaption></figure>
{% endtab %}

{% tab title="EXPLORER -> " %}
<figure><img src=".gitbook/assets/ExplorerFeatures280826.jpg" alt=""><figcaption></figcaption></figure>
{% endtab %}

{% tab title="HOME ->" %}
<figure><img src=".gitbook/assets/HomeFeatures280826.jpg" alt=""><figcaption></figcaption></figure>
{% endtab %}

{% tab title="STUDIO -> " %}
<figure><img src=".gitbook/assets/StudioFeatures280826.jpg" alt=""><figcaption></figcaption></figure>
{% endtab %}
{% endtabs %}
...
<figure><img src=".gitbook/assets/DataInputTable (1).JPG" alt=""><figcaption></figcaption></figure>
{% endtab %}
{% endtabs %}
...
<figure><img src=".gitbook/assets/InterfaceMenus280826.jpg" alt=""><figcaption><p><strong>THE 5 MAIN SHADOWMAP MENUS RARELY APPEAR AT THE SAME TIME ON THE SCREEN</strong></p></figcaption></figure>
...
{% tab title="SEARCHBOX.." %}
<figure><img src=".gitbook/assets/Location HELP diag (1).JPG" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src=".gitbook/assets/SolarAnalyticsMenu (1).JPG" alt="" width="338"><figcaption></figcaption></figure>
{% endtab %}

{% tab title="HIDE.." %}
<figure><img src=".gitbook/assets/HideorHeightMenu (1).JPG" alt=""><figcaption></figcaption></figure>
...
{% tab title="POINT N..." %}
<figure><img src=".gitbook/assets/Buttons HELP diag (1).JPG" alt=""><figcaption></figcaption></figure>
...
Current pricing can be found at [the ShadowMap website pricing page.](https://shadowmap.org/pricing)

At the time of writing in August 2026, paid versions varied from Explorer at £30/year, through Home at £8.33/month to Studio at £50/month.

<figure><img src=".gitbook/assets/shadowmapversionscreengrab280826.JPG" alt=""><figcaption></figcaption></figure>

<details>

<summary>For a comparison of the 4 Shadowmap versions, click the arrow...</summary>

<figure><img src=".gitbook/assets/Tablerevision280826.jpg" alt=""><figcaption></figcaption></figure>

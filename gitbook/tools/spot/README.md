...
| Similar Tool                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |   |
| ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | - |
| [Bellingcat OpenStreetMap Search](https://bellingcat.gitbook.io/toolkit/more/all-tools/openstreetmap-search-tool) | Bellingcat OpenStreetMap search provides an interface for querying OpenStreetMap data, helping users geolocate an image. The user interface allows one to search for structures and objects within a specified maximum distance from each other, as visible in a photo. It is a simplified version of….                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |   |
...
| [GeoGuessr GPT](https://aichatonline.org/gpts-ZxX4ERaY-GeoGuessr-GPT)                                             | <p>GeoGuessr GPT is a chat box geolocation assistant developed by <a href="https://chatgpt.com/g/g-brlHi7t2R-geoguessr-gpt">Bill Meixner</a>.</p><p><br></p><p>It uses AI to analyze terrain, structures, and other features in an image and then guesses the location or provides coordinates. Users can upload a photo and write a prompt as input. For instance, insert a picture of the Taj Mahal and ask about its origin. </p><p><br></p><p>“This is a photo of the Taj Mahal, one of the most famous landmarks in the world. It is located in India, specifically in Agra, Uttar Pradesh. The Taj Mahal is a UNESCO World Heritage site and a symbol of love, built by Emperor Shah Jahan in memory of his wife Mumtaz Mahal,” says the output by GeoGuessr GPT.</p><p><br></p><p>Next, ask for the coordinates and it will come up with relevant coords, which in this case are:</p><p><br></p><p>**Latitude:** 27.1751° N  </p><p>**Longitude:** 78.0421° E  </p><p><br></p><p>Results may vary based on the</p> |   |
| [GeoSpy](https://geospy.ai/)                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |   |
| [EarthKi](https://earthkit.ecmwf.int/)[t](https://earthkit.ecmwf.int/)                                            | Need to add this link to the tool entry: [https://earthkit.app/sift](https://earthkit.app/sift)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |   |

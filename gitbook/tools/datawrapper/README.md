...
The information on the pricing below is available at: [https://www.datawrapper.de/pricing](https://www.datawrapper.de/pricing)
...
|                                                                                                                                                                                                                                                                                                                                                                     | 599 EUR/ mo                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|                                                                                                                                                                                                                                                                                                                                                                     | 529 GBP/ mo                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| <p></p><p>The free  version is not a trial but an actual plan. </p><ul><li>Create and publish visualizations without any limits on views</li><li>Export visualizations as PNG</li><li>Includes “Created with Datawrapper” attribution</li><li>Support via email</li><li>Charts are set private by default</li><li>Charts will stay online when you cancel</li></ul> | <p></p><ul><li>Full design customization</li><li>Export as PNG, SVG, and PDF</li><li>10 user licenses included with the option to buy additional licenses for 21 USD/mo</li><li>No “Created with Datawrapper” attribution</li><li>1 custom theme (additional themes at 249 USD/mo)</li><li>Charts are set private by default</li><li>Charts will stay online when you cancel</li><li>Help via email</li><li>Priority support</li><li>Introductory training session</li></ul> | <p></p><ul><li>All features of the Free and Custom Plan</li><li>Self-hosting of visualizations (in your own infrastructure)</li><li>Service and support agreements available</li><li>25 user licenses</li><li>1 custom theme (additional themes at 249 USD/mo)</li><li>Help via email</li><li>Priority support</li><li>Introductory training session</li><li>Charts are set private by default</li><li>Charts will stay online when you cancel</li></ul> |
...
* _**Privacy:**_ [Even if you cancel your subscription or delete your account, your visualizations will remain online.](https://www.datawrapper.de/pricing) (See also: [https://www.datawrapper.de/faq#what-happens-to-my-visualizations-when-i-cancel-my-plan-or-close-my-account](https://www.datawrapper.de/faq#what-happens-to-my-visualizations-when-i-cancel-my-plan-or-close-my-account))&#x20;

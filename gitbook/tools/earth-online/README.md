...
| User need                                                     | Tool/Platform                                                                                                                                                                                                                                                                                                  | Skill level |
| ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| Orientation in Earth Observation, mission and satellite goals | ESA EO [3D Visuals](https://visuals.earth.esa.int/), news, [infographics](https://earth.esa.int/eogateway/search?category=learn-and-discover\&learn_and_discover_type=infographics); Sentinel Online [visuals](./#url)                                                                                         | :star:      |
| Read about research outcomes and use cases                    | ESA EO [Learn\&Discover ](https://earth.esa.int/eogateway/learn)interactive stories, ESA [data applications](https://visuals.earth.esa.int/data), Sentinel online [succes stories](https://sentinels.copernicus.eu/web/success-stories), Sentivista [data applications](https://sentivista.copernicus.eu/data) | :star:      |
| View and compare satellite images                             | Copernicus Browser                                                                                                                                                                                                                                                                                             | :star:      |
| Explore mission metadata, datasets                            | ESA Earth Online [Missions, Tools](https://earth.esa.int/eogateway/tools)                                                                                                                                                                                                                                      | :star:      |
| Advanced radar or optical analysis                            | SNAP                                                                                                                                                                                                                                                                                                           | :star:      |
| Bulk cloud processing or batch analysis                       | Copernicus Data Space Ecosystem (CDSE)                                                                                                                                                                                                                                                                         | :star:      |
| Advanced (scientific) research, experimental workflows        | MAAP                                                                                                                                                                                                                                                                                                           | :star:      |
| Learn workflows, methods                                      | STEP (tutorials)                                                                                                                                                                                                                                                                                               | :star:      |

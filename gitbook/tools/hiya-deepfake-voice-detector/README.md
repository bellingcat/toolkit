...
It rates the audio on a scale of 1 to 100 points: the lower the score, the higher the likelihood that the sample is fake, and the close the score is to 100, the higher the probability that it is real.

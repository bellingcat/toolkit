...
This functionality is especially useful for **OSINT researchers, investigative journalists, and analysts** who need to map social relationships, identify key influencers, and understand community structures on the platform.
...
* **Open-Source Transparency:** Developed by **Theo Sanderson** and maintained on [GitHub](https://github.com/theosanderson/bsky-follows), ensuring trust and adaptability.

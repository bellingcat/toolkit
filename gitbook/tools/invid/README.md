...
<figure><img src="../../.gitbook/assets/image (48) (1).png" alt=""><figcaption><p>I used a "real" video from the <a href="https://www.kaggle.com/datasets/reubensuju/celeb-df-v2">Celeb DF (v2) dataset</a> on Kaggle as an example. As expected, correctly classified as a real video.</p></figcaption></figure>
{% endtab %}

...
**Note:** From **25 June 2027**, Google will **no** [**longer support** downloading](https://support.google.com/earth/thread/448773864?hl=en) the **Google Earth Pro desktop version**. However, you will still be able to use it if you have already downloaded it. Depending on what you want to do, the web version may suffice. However: The desktop version is more powerful. So download it while you still can.
...
Google Earth Pro offers several [data layers](https://developers.google.com/maps/documentation/earth/available-data-layers) that can be activated via the menu. However, most of these are only available on the web and mobile versions. The layers vary and include, for example, administrative maps of cities, bike lanes, the location of fire hydrants and household income. Please note that some of these layers are only available in certain regions. Some layers are only available with a paid subscription.

How to add a layer:

1. Go to the webversion of google earth then select "Add". Then you can click on "Data layer"

<figure><img src=".gitbook/assets/Bildschirmfoto 2026-08-20 um 10.49.26.png" alt=""><figcaption></figcaption></figure>
...
4\. For New York, this layer shows the median income according to the 2020 census.
...
<figure><img src=".gitbook/assets/Bildschirmfoto 2026-08-20 um 10.52.05.png" alt=""><figcaption><p>The "Forest Cover" layer displays incorrect forest in 2026.</p></figcaption></figure>

<figure><img src=".gitbook/assets/Bildschirmfoto 2026-08-20 um 10.52.39.png" alt=""><figcaption><p>This satellite image shows the park in 2020, before the fire.</p></figcaption></figure>

<figure><img src=".gitbook/assets/Bildschirmfoto 2026-08-20 um 10.52.24.png" alt=""><figcaption><p>This satellite image shows the park in 2026, after the fire.</p></figcaption></figure>

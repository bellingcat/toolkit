...
* On YouTube, geotags are in the video creator's chosen language. E.g., a French speaker may geotag their video "États-Unis" instead of "United States". If you search on YouTube by location name, the correct language needs to be used to find geotagged videos. In comparison, if you use MW Geofind to search by coordinates this issue is not an issue.

...
You can search for YouTube videos by keywords or location (i.e., location name or coordinates), with additional filters by timeframe, video duration, and language.

...
<figure><img src=".gitbook/assets/Screenshot 2025-01-07 at 10.07.20 AM (1).png" alt=""><figcaption><p>Here's a preview of the default search</p></figcaption></figure>
...
The site has a [visualization dashboard ](https://comtrade.un.org/labs/data-explorer/)that works with the same values (import/export, country, commodity, year). There is also a set of tools to help with data analysis:
...
<figure><img src=".gitbook/assets/GpO1AVXWkAA7AN9 (1).png" alt=""><figcaption><p>Here an analytics of Ukraine in UN Comtrade <a href="https://x.com/UNTradeStats/status/1915073286586708420/photo/1">posted</a> by the Trade Statistics Branch on X.</p></figcaption></figure>

...
<figure><img src=".gitbook/assets/demo (1).gif" alt=""><figcaption><p>NeutrOSINT uses the email's associated PGP key to detect if an email exists or not.</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/image (52).png" alt=""><figcaption><p>The lock shows that the email is valid and the encryption is possible.</p></figcaption></figure>

<figure><img src=".gitbook/assets/image (1) (13).png" alt=""><figcaption><p>When the email does not exist, an error message is displayed.</p></figcaption></figure>

---
description: >-
  Live flight tracker (including many military aircraft). Live data available
...
<figure><img src=".gitbook/assets/ADS-BExchangeSelectingLADDfilter-LARGE GIF.gif" alt=""><figcaption><p>ADS-B Exchange interface showing how to navigate to the filter that shows only aircraft that submitted take-down request on other platforms.</p></figcaption></figure>

...
[https://sec-filing-fee-calculator.vercel.app/](https://sec-filing-fee-calculator.vercel.app/)
...
No registration, account, email address, API key, upload, or browser storage is required. The tools are static pages and can be saved for offline use.
...
SEC filings and related deadline information can involve sensitive issuers, investors, and transactions. Use the outputs as research notes or internal checklist rows, not as a basis for securities trading, harassment, doxxing, or legal conclusions. Cross-check any high-impact finding against official SEC sources and qualified review.

## Guides and articles

* [SEC EDGAR search](https://www.sec.gov/edgar/search/)
* [SEC filing fee rate advisories](https://www.sec.gov/newsroom/press-releases)
* [SEC beneficial ownership modernization release](https://www.sec.gov/newsroom/press-releases/2023-219)
* [SEC small-business guidance: What is Form D?](https://www.sec.gov/resources-small-businesses/capital-raising-building-blocks/what-form-d)
...
[Turner Levey](https://github.com/Turner-Levey)

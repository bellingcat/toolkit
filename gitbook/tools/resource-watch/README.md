...
* Coverage: while the global map is always shown, the scope can differ per dataset. Be aware that data coverage gaps may occur; regions can be over- or underrepresented, specific environmental topics not included, and that governmental data could reflect reporting bias.

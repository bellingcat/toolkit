...
{% tab title="MAP" %}
<figure><img src=".gitbook/assets/image (15) (1) (2).png" alt=""><figcaption><p>USE TABS TO SELECT ONE OF 3 BACKGROUND VIEWS: MAP, SATELLITE OR HYBRID</p></figcaption></figure>
{% endtab %}
{% endtabs %}

...
<img src=".gitbook/assets/image (2) (3) (1).png" alt="" data-size="original">
...
<figure><img src=".gitbook/assets/suncalcazimuthSC (1) (1).jpg" alt="" width="563"><figcaption><p><strong>THE HORIZONTAL DIRECTION OF THE SUN ON A COMPASS IS THE AZIMUTH ANGLE</strong></p></figcaption></figure>
...
{% hint style="warning" %}
The GitHub page for this tool did not contain tracking cookies on inspection at 30/6/26 BUT use of the recommended Colab route to run the code DID generate several tracking cookie alerts.
{% endhint %}

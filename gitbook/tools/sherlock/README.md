...
Be aware that the fact that Sherlock has found a specific username on various platforms, does not necessarily mean that this username belongs to a specific person or organisation. In the Bellingcat example from above, for instance, only some of the listed accounts really belong to Bellingcat (for example Github, Patreon etc.). Other accounts (including Instagram) have been created by people who are not part of Bellingcat.
